...
function show_repertoire(handles,repertoireName) 
...
title(sprintf('Syllable repertoire: %s',strtrim(regexprep(repertoire_titlename,'[_([{}()=''.(),;:%{%}!@])]',' '))),'FontSize',handles.FontSize1,'fontweight','bold');
