...
for datasetID = 1:length(datasetNames)
    ...
    bwq=sigmaf*2;
    rec_width=.2;
    plot( [bwmin bwmax],[barID barID], 'k');
    rectangle('Position',[bwqs barID-rec_width/2 bwq rec_width],'FaceColor',barcolors(barID,:)); hold on;
    plot([muf muf], [barID-rec_width barID+rec_width], 'k', 'LineWidth', 2);
